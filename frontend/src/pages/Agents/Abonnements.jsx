            ...
            <tbody>
                {filteredAbonnements.map((abonnement) => (
                    ...
                    <tr key={abonnement.id}>
                        ...
                        <td><a href="#" className='renouvelerlink' onClick={() => (setRenouvelerModal(true) , setAbonnementRe(abonnement))}><GrUpdate /></a> <a href="#" className='info' onClick={()=> navigate(`/agent/abonnement/${abonnement.client.id}/${abonnement.service.id}`)}><FaInfoCircle /></a></td>
                    </tr>
